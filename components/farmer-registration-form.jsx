...
export function FarmerRegistrationForm({ className, ...props }) {
  return (
    <div
      className={cn(
        ...
        <CardContent>
          ...
          <div className="h-[600px] overflow-y-auto pr-4">
            <form className="flex flex-col gap-6">
              ...
              <div className="grid gap-2 w-full">
                <Label htmlFor="produce" className="text-white">
                  Produce Category <span className="text-red-500">*</span>
                </Label>
                <Select>
                  <SelectTrigger className="w-full h-[50px] rounded-[10px] border-[2px] border-[#EAEDFF] bg-white px-4 py-3 text-black">
